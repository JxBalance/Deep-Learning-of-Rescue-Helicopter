...
public class HelicopterController : MonoBehaviour
{
    ...
    public float TurnTiltForce = 20f;
    ...
    {
        float upForce1 = 1 - Mathf.Clamp((HelicopterModel.transform.position.y-50.0f )/ EffectiveHeight, 0, 1);
        float upForce2 = Mathf.Lerp(0f, EngineForce, upForce1) * HelicopterModel.mass;
        HelicopterModel.AddRelativeForce(Vector3.up * upForce2);
    }
    ...
    public void StoreTheData(List<float> line, string name)
    {
